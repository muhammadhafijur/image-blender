      ...
      >
        ...
        <div class="flex space-x-4">
          ...
          <a
            href="https://www.linkedin.com/in/muhammadhafijur/"
            target="_blank"
            class="text-gray-600 dark:text-blue-700 transition duration-300 ease-out hover:scale-110 hover:text-blue-700"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-6 w-6"
            ...
            >
              ...
              ></path>
              <circle cx="7.376" cy="6.744" r="1" fill="currentColor"></circle>
              <path
                fill="currentColor"
...
.rocket-animation {
  animation: rocketMove 15s ease-out forwards;
}
