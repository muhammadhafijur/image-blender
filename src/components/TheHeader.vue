    ...
    >
      ...
      <div class="flex flex-1 items-center justify-end">
        <div class="flex items-center gap-4">
          <div class="p-1 rounded-lg transition-all duration-500 ease-in-out hover:bg-gradient-to-r hover:from-blue-500 hover:via-blue-500 hover:via-20% hover:to-purple-500 hover:to-80%">
            <a
